...
import { CheckCircle, ArrowRight, Code, Globe, Layout, Shield } from "lucide-react";

import web1 from "@/assets/service-1.jpg";
import web2 from "@/assets/service-2.jpg";
import web3 from "@/assets/service-3.jpg";
...
const features = [
  {
    ...
    title: "Modern UI/UX",
    desc: "High-end, responsive, and conversion-focused website designs.",
  },
  {
    icon: <Code className="w-6 h-6" />,
    title: "Scalable Development",
    desc: "Clean and secure code using modern frameworks and standards.",
  },
  {
    icon: <Shield className="w-6 h-6" />,
    title: "Secure Systems",
    desc: "Enterprise-level security, performance, and reliability.",
  },
  {
    icon: <Globe className="w-6 h-6" />,
    title: "SEO Friendly",
    desc: "Optimized websites for speed, ranking, and best practices.",
  },
];
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-3xl mx-auto text-muted-foreground text-lg">
            ...
            that help businesses grow, scale, and dominate digitally.
          </p>
        </div>
      </section>
      ...
      <section className="section-gap bg-background">
        <div className="container mx-auto px-4 text-center mb-12">
          ...
          <p className="text-muted-foreground">
            Some of our successful web-based solutions for businesses.
          </p>
        </div>
      ...
      <section className="section-gap bg-gradient-to-r from-primary to-accent text-primary-foreground text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="mb-8 text-primary-foreground/80">
            Let’s build a fast, secure, and scalable web solution for you.
          </p>
